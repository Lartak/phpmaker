 ...
 * Page class
 */
class gantt_edit extends gantt
{
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// start
			$this->start->setDbValueDef($rsnew, UnFormatDateTime($this->start->CurrentValue, 0), CurrentDate(), $this->start->ReadOnly);

			// end
			$this->end->setDbValueDef($rsnew, UnFormatDateTime($this->end->CurrentValue, 0), CurrentDate(), $this->end->ReadOnly);
