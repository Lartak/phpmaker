...
class products extends DbTable
{
	...
	public function __construct()
	{
		...
		// ProductID
		$this->ProductID = new DbField('products', 'products', 'x_ProductID', 'ProductID', '`ProductID`', '`ProductID`', 3, -1, FALSE, '`ProductID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ProductName
		$this->ProductName = new DbField('products', 'products', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// SupplierID
		$this->SupplierID = new DbField('products', 'products', 'x_SupplierID', 'SupplierID', '`SupplierID`', '`SupplierID`', 3, -1, FALSE, '`SupplierID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CategoryID
		$this->CategoryID = new DbField('products', 'products', 'x_CategoryID', 'CategoryID', '`CategoryID`', '`CategoryID`', 3, -1, FALSE, '`CategoryID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// QuantityPerUnit
		$this->QuantityPerUnit = new DbField('products', 'products', 'x_QuantityPerUnit', 'QuantityPerUnit', '`QuantityPerUnit`', '`QuantityPerUnit`', 200, -1, FALSE, '`QuantityPerUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QuantityPerUnit->Sortable = TRUE; // Allow sort
		$this->fields['QuantityPerUnit'] = &$this->QuantityPerUnit;

		// UnitPrice
		$this->UnitPrice = new DbField('products', 'products', 'x_UnitPrice', 'UnitPrice', '`UnitPrice`', '`UnitPrice`', 5, -1, FALSE, '`UnitPrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitsInStock
		$this->UnitsInStock = new DbField('products', 'products', 'x_UnitsInStock', 'UnitsInStock', '`UnitsInStock`', '`UnitsInStock`', 2, -1, FALSE, '`UnitsInStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitsOnOrder
		$this->UnitsOnOrder = new DbField('products', 'products', 'x_UnitsOnOrder', 'UnitsOnOrder', '`UnitsOnOrder`', '`UnitsOnOrder`', 2, -1, FALSE, '`UnitsOnOrder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReorderLevel
		$this->ReorderLevel = new DbField('products', 'products', 'x_ReorderLevel', 'ReorderLevel', '`ReorderLevel`', '`ReorderLevel`', 2, -1, FALSE, '`ReorderLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Discontinued
		$this->Discontinued = new DbField('products', 'products', 'x_Discontinued', 'Discontinued', '`Discontinued`', '`Discontinued`', 202, -1, FALSE, '`Discontinued`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("productsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
