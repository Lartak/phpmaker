 ...
 * Page class
 */
class order_details_extended_list extends order_details_extended
{
	...
	// Table name
	public $TableName = 'order details extended';

	// Page object name
	public $PageObjName = "order_details_extended_list";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["order_details_extended"]) || get_class($GLOBALS["order_details_extended"]) == PROJECT_NAMESPACE . "order_details_extended") {
			$GLOBALS["order_details_extended"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["order_details_extended"];
		}
		...
		$this->AddUrl = "order_details_extendedadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "order_details_extendeddelete.php";
		$this->MultiUpdateUrl = "order_details_extendedupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option forder_details_extendedlistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $order_details_extended;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($order_details_extended);
				$doc->Text = @$content;
	...
	public function run()
	{
		...
		$this->Extended_Price->setVisibility();
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->Extended_Price->AdvancedSearch->toJson(), ","); // Field Extended Price
		if ($this->BasicSearch->Keyword <> "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "forder_details_extendedlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		$this->Extended_Price->AdvancedSearch->SearchValue = @$filter["x_Extended_Price"];
		$this->Extended_Price->AdvancedSearch->SearchOperator = @$filter["z_Extended_Price"];
		$this->Extended_Price->AdvancedSearch->SearchCondition = @$filter["v_Extended_Price"];
		$this->Extended_Price->AdvancedSearch->SearchValue2 = @$filter["y_Extended_Price"];
		$this->Extended_Price->AdvancedSearch->SearchOperator2 = @$filter["w_Extended_Price"];
		$this->Extended_Price->AdvancedSearch->save();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Extended_Price); // Extended Price
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"forder_details_extendedlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"forder_details_extendedlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.forder_details_extendedlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"forder_details_extendedlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->Extended_Price->setDbValue($row['Extended Price']);
	}
	...
	public function renderRow()
	{
		...
		// Convert decimal values if posted back
		if ($this->Extended_Price->FormValue == $this->Extended_Price->CurrentValue && is_numeric(ConvertToFloatString($this->Extended_Price->CurrentValue)))
			$this->Extended_Price->CurrentValue = ConvertToFloatString($this->Extended_Price->CurrentValue);
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_order_details_extended\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_order_details_extended',hdr:ew.language.phrase('ExportToEmailText'),f:document.forder_details_extendedlist,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
