...
class models extends DbTable
{
	...
	public function __construct()
	{
		...
		// ID
		$this->ID = new DbField('models', 'models', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Trademark
		$this->Trademark = new DbField('models', 'models', 'x_Trademark', 'Trademark', '`Trademark`', '`Trademark`', 3, -1, FALSE, '`Trademark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Model
		$this->Model = new DbField('models', 'models', 'x_Model', 'Model', '`Model`', '`Model`', 200, -1, FALSE, '`Model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "modelsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "modelsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "modelsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("modelsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("modelsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "modelsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "modelsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("modelsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("modelsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("modelsdelete.php", $this->getUrlParm());
	}
