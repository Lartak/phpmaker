...
class cars_edit extends cars
{
	...
	public function run()
	{
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->terminate("carslist.php"); // Return to list page
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Trademark
			$this->Trademark->setDbValueDef($rsnew, $this->Trademark->CurrentValue, NULL, $this->Trademark->ReadOnly);
			...
			// Liter
			$this->Liter->setDbValueDef($rsnew, $this->Liter->CurrentValue, NULL, $this->Liter->ReadOnly);

			// Cyl
			$this->Cyl->setDbValueDef($rsnew, $this->Cyl->CurrentValue, NULL, $this->Cyl->ReadOnly);

			// TransmissSpeedCount
			$this->TransmissSpeedCount->setDbValueDef($rsnew, $this->TransmissSpeedCount->CurrentValue, NULL, $this->TransmissSpeedCount->ReadOnly);

			// TransmissAutomatic
			$this->TransmissAutomatic->setDbValueDef($rsnew, $this->TransmissAutomatic->CurrentValue, NULL, $this->TransmissAutomatic->ReadOnly);

			// MPG_City
			$this->MPG_City->setDbValueDef($rsnew, $this->MPG_City->CurrentValue, NULL, $this->MPG_City->ReadOnly);

			// MPG_Highway
			$this->MPG_Highway->setDbValueDef($rsnew, $this->MPG_Highway->CurrentValue, NULL, $this->MPG_Highway->ReadOnly);
			...
			// Hyperlink
			$this->Hyperlink->setDbValueDef($rsnew, $this->Hyperlink->CurrentValue, NULL, $this->Hyperlink->ReadOnly);
			...
			// PictureName
			$this->PictureName->setDbValueDef($rsnew, $this->PictureName->CurrentValue, NULL, $this->PictureName->ReadOnly);

			// PictureSize
			$this->PictureSize->setDbValueDef($rsnew, $this->PictureSize->CurrentValue, NULL, $this->PictureSize->ReadOnly);

			// PictureType
			$this->PictureType->setDbValueDef($rsnew, $this->PictureType->CurrentValue, NULL, $this->PictureType->ReadOnly);

			// PictureWidth
			$this->PictureWidth->setDbValueDef($rsnew, $this->PictureWidth->CurrentValue, NULL, $this->PictureWidth->ReadOnly);

			// PictureHeight
			$this->PictureHeight->setDbValueDef($rsnew, $this->PictureHeight->CurrentValue, NULL, $this->PictureHeight->ReadOnly);
