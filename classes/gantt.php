...
class gantt extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('gantt', 'gantt', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// name
		$this->name = new DbField('gantt', 'gantt', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// start
		$this->start = new DbField('gantt', 'gantt', 'x_start', 'start', '`start`', CastDateFieldForLike('`start`', 0, "demo2"), 135, 0, FALSE, '`start`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// end
		$this->end = new DbField('gantt', 'gantt', 'x_end', 'end', '`end`', CastDateFieldForLike('`end`', 0, "demo2"), 135, 0, FALSE, '`end`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "ganttview.php")
			return $Language->phrase("View");
		elseif ($pageName == "ganttedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ganttadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("ganttview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ganttview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "ganttadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ganttadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ganttedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ganttadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ganttdelete.php", $this->getUrlParm());
	}
