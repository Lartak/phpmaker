...
class orderdetails extends DbTable
{
	...
	public function __construct()
	{
		...
		// OrderID
		$this->OrderID = new DbField('orderdetails', 'orderdetails', 'x_OrderID', 'OrderID', '`OrderID`', '`OrderID`', 3, -1, FALSE, '`OrderID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductID
		$this->ProductID = new DbField('orderdetails', 'orderdetails', 'x_ProductID', 'ProductID', '`ProductID`', '`ProductID`', 3, -1, FALSE, '`ProductID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitPrice
		$this->UnitPrice = new DbField('orderdetails', 'orderdetails', 'x_UnitPrice', 'UnitPrice', '`UnitPrice`', '`UnitPrice`', 5, -1, FALSE, '`UnitPrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new DbField('orderdetails', 'orderdetails', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 2, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quantity->Sortable = TRUE; // Allow sort
		$this->Quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Quantity'] = &$this->Quantity;

		// Discount
		$this->Discount = new DbField('orderdetails', 'orderdetails', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 5, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("orderdetailsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("orderdetailsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "orderdetailsadd.php?" . $this->getUrlParm($parm);
		else
	...
	{
		$url = $this->keyUrl("orderdetailsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("orderdetailsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("orderdetailsdelete.php", $this->getUrlParm());
	}
