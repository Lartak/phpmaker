 ...
 * Page class
 */
class trademarks_add extends trademarks
{
	...
	// Page object name
	public $PageObjName = "trademarks_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("trademarkslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "trademarksview.php")
