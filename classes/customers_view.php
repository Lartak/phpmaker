			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->terminate("customerslist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (SameString($this->CustomerID->CurrentValue, $this->Recordset->fields('CustomerID'))) {
