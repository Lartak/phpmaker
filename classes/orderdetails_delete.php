 ...
 * Page class
 */
class orderdetails_delete extends orderdetails
{
	...
	// Page object name
	public $PageObjName = "orderdetails_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("orderdetailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("orderdetailslist.php"); // Return to list
			}
		}
	}
