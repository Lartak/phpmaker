...
class suppliers extends DbTable
{
	...
	public function __construct()
	{
		...
		// SupplierID
		$this->SupplierID = new DbField('suppliers', 'suppliers', 'x_SupplierID', 'SupplierID', '`SupplierID`', '`SupplierID`', 3, -1, FALSE, '`SupplierID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// CompanyName
		$this->CompanyName = new DbField('suppliers', 'suppliers', 'x_CompanyName', 'CompanyName', '`CompanyName`', '`CompanyName`', 200, -1, FALSE, '`CompanyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CompanyName->Sortable = TRUE; // Allow sort
		$this->fields['CompanyName'] = &$this->CompanyName;

		// ContactName
		$this->ContactName = new DbField('suppliers', 'suppliers', 'x_ContactName', 'ContactName', '`ContactName`', '`ContactName`', 200, -1, FALSE, '`ContactName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactName->Sortable = TRUE; // Allow sort
		$this->fields['ContactName'] = &$this->ContactName;

		// ContactTitle
		$this->ContactTitle = new DbField('suppliers', 'suppliers', 'x_ContactTitle', 'ContactTitle', '`ContactTitle`', '`ContactTitle`', 200, -1, FALSE, '`ContactTitle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ContactTitle->Sortable = TRUE; // Allow sort
		$this->fields['ContactTitle'] = &$this->ContactTitle;

		// Address
		$this->Address = new DbField('suppliers', 'suppliers', 'x_Address', 'Address', '`Address`', '`Address`', 200, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address->Sortable = TRUE; // Allow sort
		$this->fields['Address'] = &$this->Address;

		// City
		$this->City = new DbField('suppliers', 'suppliers', 'x_City', 'City', '`City`', '`City`', 200, -1, FALSE, '`City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->City->Sortable = TRUE; // Allow sort
		$this->fields['City'] = &$this->City;

		// Region
		$this->Region = new DbField('suppliers', 'suppliers', 'x_Region', 'Region', '`Region`', '`Region`', 200, -1, FALSE, '`Region`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Region->Sortable = TRUE; // Allow sort
		$this->fields['Region'] = &$this->Region;

		// PostalCode
		$this->PostalCode = new DbField('suppliers', 'suppliers', 'x_PostalCode', 'PostalCode', '`PostalCode`', '`PostalCode`', 200, -1, FALSE, '`PostalCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PostalCode->Sortable = TRUE; // Allow sort
		$this->fields['PostalCode'] = &$this->PostalCode;

		// Country
		$this->Country = new DbField('suppliers', 'suppliers', 'x_Country', 'Country', '`Country`', '`Country`', 200, -1, FALSE, '`Country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Country->Sortable = TRUE; // Allow sort
		$this->fields['Country'] = &$this->Country;

		// Phone
		$this->Phone = new DbField('suppliers', 'suppliers', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, -1, FALSE, '`Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Phone->Sortable = TRUE; // Allow sort
		$this->fields['Phone'] = &$this->Phone;

		// Fax
		$this->Fax = new DbField('suppliers', 'suppliers', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, -1, FALSE, '`Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fax->Sortable = TRUE; // Allow sort
		$this->fields['Fax'] = &$this->Fax;

		// HomePage
		$this->HomePage = new DbField('suppliers', 'suppliers', 'x_HomePage', 'HomePage', '`HomePage`', '`HomePage`', 201, -1, FALSE, '`HomePage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getRecordFilter($row = NULL)
	{
		...
		$val = is_array($row) ? (array_key_exists('SupplierID', $row) ? $row['SupplierID'] : NULL) : $this->SupplierID->CurrentValue;
		if (!is_numeric($val))
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("suppliersview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
