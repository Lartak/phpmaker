 ...
 * Page class
 */
class models_delete extends models
{
	...
	// Page object name
	public $PageObjName = "models_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("modelslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("modelslist.php"); // Return to list
			}
		}
	}
