...
class categories_edit extends categories
{
	...
	protected function validateForm()
	{
		...
		if ($this->CategoryName->Required) {
			if (!$this->CategoryName->IsDetailKey && $this->CategoryName->FormValue != NULL && $this->CategoryName->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->CategoryName->caption(), $this->CategoryName->RequiredErrorMessage));
			}
		}
