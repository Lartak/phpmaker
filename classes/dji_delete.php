...
class dji_delete extends dji
{
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("djilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("djilist.php"); // Return to list
			}
		}
	}
