 ...
 * Page class
 */
class gantt_delete extends gantt
{
	...
	// Page object name
	public $PageObjName = "gantt_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ganttlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("ganttlist.php"); // Return to list
			}
		}
	}
