...
class categories extends DbTable
{
	...
	public function __construct()
	{
		...
		// CategoryID
		$this->CategoryID = new DbField('categories', 'categories', 'x_CategoryID', 'CategoryID', '`CategoryID`', '`CategoryID`', 3, -1, FALSE, '`CategoryID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// CategoryName
		$this->CategoryName = new DbField('categories', 'categories', 'x_CategoryName', 'CategoryName', '`CategoryName`', '`CategoryName`', 200, -1, FALSE, '`CategoryName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Picture
		$this->Picture = new DbField('categories', 'categories', 'x_Picture', 'Picture', '`Picture`', '`Picture`', 205, -1, TRUE, '`Picture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
