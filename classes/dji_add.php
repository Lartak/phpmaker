...
class dji_add extends dji
{
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "djiview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->High->CurrentValue = NULL;
		$this->High->OldValue = $this->High->CurrentValue;
		$this->Low->CurrentValue = NULL;
		$this->Low->OldValue = $this->Low->CurrentValue;
		...
		$this->Adj_Close->CurrentValue = NULL;
		$this->Adj_Close->OldValue = $this->Adj_Close->CurrentValue;
		$this->Name->CurrentValue = NULL;
		$this->Name->OldValue = $this->Name->CurrentValue;
		$this->Name2->CurrentValue = NULL;
		$this->Name2->OldValue = $this->Name2->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['High'] = $this->High->CurrentValue;
		$row['Low'] = $this->Low->CurrentValue;
		$row['Close'] = $this->Close->CurrentValue;
		$row['Volume'] = $this->Volume->CurrentValue;
		$row['Adj Close'] = $this->Adj_Close->CurrentValue;
		$row['Name'] = $this->Name->CurrentValue;
		$row['Name2'] = $this->Name2->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// High
		$this->High->setDbValueDef($rsnew, $this->High->CurrentValue, NULL, FALSE);

		// Low
		$this->Low->setDbValueDef($rsnew, $this->Low->CurrentValue, NULL, FALSE);
		...
		// Adj Close
		$this->Adj_Close->setDbValueDef($rsnew, $this->Adj_Close->CurrentValue, NULL, FALSE);

		// Name
		$this->Name->setDbValueDef($rsnew, UnFormatDateTime($this->Name->CurrentValue, 0), NULL, FALSE);

		// Name2
		$this->Name2->setDbValueDef($rsnew, $this->Name2->CurrentValue, NULL, FALSE);
