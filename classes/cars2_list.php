 ...
 * Page class
 */
class cars2_list extends cars2
{
	...
	// Table name
	public $TableName = 'cars2';

	// Page object name
	public $PageObjName = "cars2_list";
	...
	public function __construct()
	{
		...
		// Table object (cars2)
		if (!isset($GLOBALS["cars2"]) || get_class($GLOBALS["cars2"]) == PROJECT_NAMESPACE . "cars2") {
			$GLOBALS["cars2"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["cars2"];
		}
		...
		$this->AddUrl = "cars2add.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "cars2delete.php";
		$this->MultiUpdateUrl = "cars2update.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fcars2listsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->Liter->AdvancedSearch->toJson(), ","); // Field Liter
		$filterList = Concat($filterList, $this->Cyl->AdvancedSearch->toJson(), ","); // Field Cyl
		$filterList = Concat($filterList, $this->TransmissSpeedCount->AdvancedSearch->toJson(), ","); // Field TransmissSpeedCount
		$filterList = Concat($filterList, $this->TransmissAutomatic->AdvancedSearch->toJson(), ","); // Field TransmissAutomatic
		$filterList = Concat($filterList, $this->MPG_City->AdvancedSearch->toJson(), ","); // Field MPG_City
		$filterList = Concat($filterList, $this->MPG_Highway->AdvancedSearch->toJson(), ","); // Field MPG_Highway
		$filterList = Concat($filterList, $this->Category->AdvancedSearch->toJson(), ","); // Field Category
		$filterList = Concat($filterList, $this->Description->AdvancedSearch->toJson(), ","); // Field Description
		$filterList = Concat($filterList, $this->Hyperlink->AdvancedSearch->toJson(), ","); // Field Hyperlink
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fcars2listsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field Liter
		$this->Liter->AdvancedSearch->SearchValue = @$filter["x_Liter"];
		$this->Liter->AdvancedSearch->SearchOperator = @$filter["z_Liter"];
		$this->Liter->AdvancedSearch->SearchCondition = @$filter["v_Liter"];
		$this->Liter->AdvancedSearch->SearchValue2 = @$filter["y_Liter"];
		$this->Liter->AdvancedSearch->SearchOperator2 = @$filter["w_Liter"];
		$this->Liter->AdvancedSearch->save();

		// Field Cyl
		$this->Cyl->AdvancedSearch->SearchValue = @$filter["x_Cyl"];
		$this->Cyl->AdvancedSearch->SearchOperator = @$filter["z_Cyl"];
		$this->Cyl->AdvancedSearch->SearchCondition = @$filter["v_Cyl"];
		$this->Cyl->AdvancedSearch->SearchValue2 = @$filter["y_Cyl"];
		$this->Cyl->AdvancedSearch->SearchOperator2 = @$filter["w_Cyl"];
		$this->Cyl->AdvancedSearch->save();

		// Field TransmissSpeedCount
		$this->TransmissSpeedCount->AdvancedSearch->SearchValue = @$filter["x_TransmissSpeedCount"];
		$this->TransmissSpeedCount->AdvancedSearch->SearchOperator = @$filter["z_TransmissSpeedCount"];
		$this->TransmissSpeedCount->AdvancedSearch->SearchCondition = @$filter["v_TransmissSpeedCount"];
		$this->TransmissSpeedCount->AdvancedSearch->SearchValue2 = @$filter["y_TransmissSpeedCount"];
		$this->TransmissSpeedCount->AdvancedSearch->SearchOperator2 = @$filter["w_TransmissSpeedCount"];
		$this->TransmissSpeedCount->AdvancedSearch->save();
		...
		// Field MPG_City
		$this->MPG_City->AdvancedSearch->SearchValue = @$filter["x_MPG_City"];
		$this->MPG_City->AdvancedSearch->SearchOperator = @$filter["z_MPG_City"];
		$this->MPG_City->AdvancedSearch->SearchCondition = @$filter["v_MPG_City"];
		$this->MPG_City->AdvancedSearch->SearchValue2 = @$filter["y_MPG_City"];
		$this->MPG_City->AdvancedSearch->SearchOperator2 = @$filter["w_MPG_City"];
		$this->MPG_City->AdvancedSearch->save();

		// Field MPG_Highway
		$this->MPG_Highway->AdvancedSearch->SearchValue = @$filter["x_MPG_Highway"];
		$this->MPG_Highway->AdvancedSearch->SearchOperator = @$filter["z_MPG_Highway"];
		$this->MPG_Highway->AdvancedSearch->SearchCondition = @$filter["v_MPG_Highway"];
		$this->MPG_Highway->AdvancedSearch->SearchValue2 = @$filter["y_MPG_Highway"];
		$this->MPG_Highway->AdvancedSearch->SearchOperator2 = @$filter["w_MPG_Highway"];
		$this->MPG_Highway->AdvancedSearch->save();
		...
		// Field Hyperlink
		$this->Hyperlink->AdvancedSearch->SearchValue = @$filter["x_Hyperlink"];
		$this->Hyperlink->AdvancedSearch->SearchOperator = @$filter["z_Hyperlink"];
		$this->Hyperlink->AdvancedSearch->SearchCondition = @$filter["v_Hyperlink"];
		$this->Hyperlink->AdvancedSearch->SearchValue2 = @$filter["y_Hyperlink"];
		$this->Hyperlink->AdvancedSearch->SearchOperator2 = @$filter["w_Hyperlink"];
		$this->Hyperlink->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->TransmissAutomatic, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->Hyperlink, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Liter); // Liter
			$this->updateSort($this->Cyl); // Cyl
			$this->updateSort($this->TransmissSpeedCount); // TransmissSpeedCount
			$this->updateSort($this->TransmissAutomatic); // TransmissAutomatic
			$this->updateSort($this->MPG_City); // MPG_City
			$this->updateSort($this->MPG_Highway); // MPG_Highway
			$this->updateSort($this->Category); // Category
			$this->updateSort($this->Hyperlink); // Hyperlink
			$this->updateSort($this->Price); // Price
			$this->updateSort($this->PictureName); // PictureName
			$this->updateSort($this->PictureSize); // PictureSize
			$this->updateSort($this->PictureType); // PictureType
			$this->updateSort($this->PictureWidth); // PictureWidth
			$this->updateSort($this->PictureHeight); // PictureHeight
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->Liter->setSort("");
				$this->Cyl->setSort("");
				$this->TransmissSpeedCount->setSort("");
				$this->TransmissAutomatic->setSort("");
				$this->MPG_City->setSort("");
				$this->MPG_Highway->setSort("");
				$this->Category->setSort("");
				$this->Hyperlink->setSort("");
				$this->Price->setSort("");
				$this->PictureName->setSort("");
				$this->PictureSize->setSort("");
				$this->PictureType->setSort("");
				$this->PictureWidth->setSort("");
				$this->PictureHeight->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fcars2listsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcars2listsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fcars2list}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fcars2listsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_cars2\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_cars2',hdr:ew.language.phrase('ExportToEmailText'),f:document.fcars2list,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
