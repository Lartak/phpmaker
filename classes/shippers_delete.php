 ...
 * Page class
 */
class shippers_delete extends shippers
{
	...
	// Page object name
	public $PageObjName = "shippers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("shipperslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("shipperslist.php"); // Return to list
			}
		}
	}
