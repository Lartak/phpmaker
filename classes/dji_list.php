...
class dji_list extends dji
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "djiadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "djidelete.php";
		$this->MultiUpdateUrl = "djiupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fdjilistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->Adj_Close->AdvancedSearch->toJson(), ","); // Field Adj Close
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fdjilistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field Adj Close
		$this->Adj_Close->AdvancedSearch->SearchValue = @$filter["x_Adj_Close"];
		$this->Adj_Close->AdvancedSearch->SearchOperator = @$filter["z_Adj_Close"];
		$this->Adj_Close->AdvancedSearch->SearchCondition = @$filter["v_Adj_Close"];
		$this->Adj_Close->AdvancedSearch->SearchValue2 = @$filter["y_Adj_Close"];
		$this->Adj_Close->AdvancedSearch->SearchOperator2 = @$filter["w_Adj_Close"];
		$this->Adj_Close->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->Name2, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->Adj_Close); // Adj Close
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fdjilistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdjilistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fdjilist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fdjilistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_dji\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_dji',hdr:ew.language.phrase('ExportToEmailText'),f:document.fdjilist,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
