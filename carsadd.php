...
<?php if (!$cars_add->IsMobileOrModal) { ?>
<div class="ew-desktop"><!-- desktop -->
<?php } ?>
<?php if ($cars_add->IsMobileOrModal) { ?>
<div class="ew-add-div"><!-- page* -->
<?php } else { ?>
<table id="tbl_carsadd" class="table ew-desktop-table"><!-- table* -->
<?php } ?>
<?php if ($cars->Trademark->Visible) { // Trademark ?>
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Trademark" class="form-group row">
		<label id="elh_cars_Trademark" for="x_Trademark" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Trademark->caption() ?><?php echo ($cars->Trademark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Trademark->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Trademark">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Trademark"><?php echo $cars->Trademark->caption() ?><?php echo ($cars->Trademark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Model" class="form-group row">
		<label id="elh_cars_Model" for="x_Model" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Model->caption() ?><?php echo ($cars->Model->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Model->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Model">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Model"><?php echo $cars->Model->caption() ?><?php echo ($cars->Model->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_HP" class="form-group row">
		<label id="elh_cars_HP" for="x_HP" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->HP->caption() ?><?php echo ($cars->HP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->HP->cellAttributes() ?>>
<span id="el_cars_HP">
...
<?php } else { ?>
	<tr id="r_HP">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_HP"><?php echo $cars->HP->caption() ?><?php echo ($cars->HP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Liter" class="form-group row">
		<label id="elh_cars_Liter" for="x_Liter" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Liter->caption() ?><?php echo ($cars->Liter->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Liter->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Liter">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Liter"><?php echo $cars->Liter->caption() ?><?php echo ($cars->Liter->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Cyl" class="form-group row">
		<label id="elh_cars_Cyl" for="x_Cyl" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Cyl->caption() ?><?php echo ($cars->Cyl->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Cyl->cellAttributes() ?>>
<span id="el_cars_Cyl">
...
<?php } else { ?>
	<tr id="r_Cyl">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Cyl"><?php echo $cars->Cyl->caption() ?><?php echo ($cars->Cyl->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_TransmissSpeedCount" class="form-group row">
		<label id="elh_cars_TransmissSpeedCount" for="x_TransmissSpeedCount" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->TransmissSpeedCount->caption() ?><?php echo ($cars->TransmissSpeedCount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->TransmissSpeedCount->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_TransmissSpeedCount">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_TransmissSpeedCount"><?php echo $cars->TransmissSpeedCount->caption() ?><?php echo ($cars->TransmissSpeedCount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_TransmissAutomatic" class="form-group row">
		<label id="elh_cars_TransmissAutomatic" for="x_TransmissAutomatic" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->TransmissAutomatic->caption() ?><?php echo ($cars->TransmissAutomatic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->TransmissAutomatic->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_TransmissAutomatic">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_TransmissAutomatic"><?php echo $cars->TransmissAutomatic->caption() ?><?php echo ($cars->TransmissAutomatic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_MPG_City" class="form-group row">
		<label id="elh_cars_MPG_City" for="x_MPG_City" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->MPG_City->caption() ?><?php echo ($cars->MPG_City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->MPG_City->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_MPG_City">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_MPG_City"><?php echo $cars->MPG_City->caption() ?><?php echo ($cars->MPG_City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_MPG_Highway" class="form-group row">
		<label id="elh_cars_MPG_Highway" for="x_MPG_Highway" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->MPG_Highway->caption() ?><?php echo ($cars->MPG_Highway->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->MPG_Highway->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_MPG_Highway">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_MPG_Highway"><?php echo $cars->MPG_Highway->caption() ?><?php echo ($cars->MPG_Highway->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Category" class="form-group row">
		<label id="elh_cars_Category" for="x_Category" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Category->caption() ?><?php echo ($cars->Category->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Category->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Category">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Category"><?php echo $cars->Category->caption() ?><?php echo ($cars->Category->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Description" class="form-group row">
		<label id="elh_cars_Description" for="x_Description" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Description->caption() ?><?php echo ($cars->Description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Description->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Description">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Description"><?php echo $cars->Description->caption() ?><?php echo ($cars->Description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Hyperlink" class="form-group row">
		<label id="elh_cars_Hyperlink" for="x_Hyperlink" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Hyperlink->caption() ?><?php echo ($cars->Hyperlink->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Hyperlink->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Hyperlink">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Hyperlink"><?php echo $cars->Hyperlink->caption() ?><?php echo ($cars->Hyperlink->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Price" class="form-group row">
		<label id="elh_cars_Price" for="x_Price" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Price->caption() ?><?php echo ($cars->Price->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Price->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Price">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Price"><?php echo $cars->Price->caption() ?><?php echo ($cars->Price->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Picture" class="form-group row">
		<label id="elh_cars_Picture" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Picture->caption() ?><?php echo ($cars->Picture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Picture->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Picture">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Picture"><?php echo $cars->Picture->caption() ?><?php echo ($cars->Picture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_PictureName" class="form-group row">
		<label id="elh_cars_PictureName" for="x_PictureName" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->PictureName->caption() ?><?php echo ($cars->PictureName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->PictureName->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_PictureName">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_PictureName"><?php echo $cars->PictureName->caption() ?><?php echo ($cars->PictureName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_PictureSize" class="form-group row">
		<label id="elh_cars_PictureSize" for="x_PictureSize" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->PictureSize->caption() ?><?php echo ($cars->PictureSize->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->PictureSize->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_PictureSize">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_PictureSize"><?php echo $cars->PictureSize->caption() ?><?php echo ($cars->PictureSize->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_PictureType" class="form-group row">
		<label id="elh_cars_PictureType" for="x_PictureType" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->PictureType->caption() ?><?php echo ($cars->PictureType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->PictureType->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_PictureType">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_PictureType"><?php echo $cars->PictureType->caption() ?><?php echo ($cars->PictureType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_PictureWidth" class="form-group row">
		<label id="elh_cars_PictureWidth" for="x_PictureWidth" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->PictureWidth->caption() ?><?php echo ($cars->PictureWidth->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->PictureWidth->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_PictureWidth">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_PictureWidth"><?php echo $cars->PictureWidth->caption() ?><?php echo ($cars->PictureWidth->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_PictureHeight" class="form-group row">
		<label id="elh_cars_PictureHeight" for="x_PictureHeight" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->PictureHeight->caption() ?><?php echo ($cars->PictureHeight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->PictureHeight->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_PictureHeight">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_PictureHeight"><?php echo $cars->PictureHeight->caption() ?><?php echo ($cars->PictureHeight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($cars_add->IsMobileOrModal) { ?>
	<div id="r_Color" class="form-group row">
		<label id="elh_cars_Color" for="x_Color" class="<?php echo $cars_add->LeftColumnClass ?>"><?php echo $cars->Color->caption() ?><?php echo ($cars->Color->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cars_add->RightColumnClass ?>"><div<?php echo $cars->Color->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Color">
		<td class="<?php echo $cars_add->TableLeftColumnClass ?>"><span id="elh_cars_Color"><?php echo $cars->Color->caption() ?><?php echo ($cars->Color->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
