...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "15.0.4");
...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "demo2019"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{DFB61542-7FFC-43AB-88E7-31D7F8D95066}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", '4xPPFkpfFr28932L'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/demo2019.css"); // Project stylesheet file name
...
$AUTH_CONFIG = [
	"providers" => [
		"Google" => [
			"enabled" => true,
			"keys" => ["id" => "your-google-client-id-here", "secret" => "your-google-client-secret-here"],
			"color" => "danger"
		],
		"Facebook" => [
			"enabled" => true,
			"keys" => ["id" => "your-facebook-app-id-here", "secret" => "your-facebook-app-secret-here"],
			"color" => "primary",
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "root", "db" => "demo2019", "qs" => "`", "qe" => "`");
$CONNECTIONS[0] = &$CONNECTIONS["DB"];
$CONNECTIONS["demo20191"] = array("conn" => NULL, "id" => "demo20191", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "root", "db" => "demo2019", "qs" => "`", "qe" => "`", "new" => TRUE);
$CONNECTIONS[1] = &$CONNECTIONS["demo20191"];
$CONNECTIONS["demo2"] = array("conn" => NULL, "id" => "demo2", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "root", "db" => "demo2", "qs" => "`", "qe" => "`", "new" => TRUE);
$CONNECTIONS[2] = &$CONNECTIONS["demo2"];
...
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "admin@mycompany.com"); // Sender email address
define(PROJECT_NAMESPACE . "RECIPIENT_EMAIL", "admin@mycompany.com"); // Recipient email address
...
define(PROJECT_NAMESPACE . "IMAGE_ALLOWED_FILE_EXT", "gif,jpg,png,bmp"); // Allowed file extensions for images
...
// Audit trail
define(PROJECT_NAMESPACE . "AUDIT_TRAIL_PATH", "log/"); // Audit trail path (relative to app root)
...
// Page Title Style
define(PROJECT_NAMESPACE . "PAGE_TITLE_STYLE", "Breadcrumb");
