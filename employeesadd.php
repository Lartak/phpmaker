...
femployeesadd.lists["x_Activated[]"] = <?php echo $employees_add->Activated->Lookup->toClientList() ?>;
...
<?php } else { ?>
<table id="tbl_employeesadd" class="table ew-desktop-table"><!-- table* -->
<?php } ?>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_Title" class="form-group row">
		<label id="elh_employees_Title" for="x_Title" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->Title->caption() ?><?php echo ($employees->Title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
	<tr id="r_Title">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_Title"><?php echo $employees->Title->caption() ?><?php echo ($employees->Title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_TitleOfCourtesy" class="form-group row">
		<label id="elh_employees_TitleOfCourtesy" for="x_TitleOfCourtesy" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->TitleOfCourtesy->caption() ?><?php echo ($employees->TitleOfCourtesy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->TitleOfCourtesy->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_TitleOfCourtesy">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_TitleOfCourtesy"><?php echo $employees->TitleOfCourtesy->caption() ?><?php echo ($employees->TitleOfCourtesy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_HireDate" class="form-group row">
		<label id="elh_employees_HireDate" for="x_HireDate" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->HireDate->caption() ?><?php echo ($employees->HireDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->HireDate->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_HireDate">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_HireDate"><?php echo $employees->HireDate->caption() ?><?php echo ($employees->HireDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
	<tr id="r_Address">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_Address"><?php echo $employees->Address->caption() ?><?php echo ($employees->Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_City" class="form-group row">
		<label id="elh_employees_City" for="x_City" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->City->caption() ?><?php echo ($employees->City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->City->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_City">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_City"><?php echo $employees->City->caption() ?><?php echo ($employees->City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_Region" class="form-group row">
		<label id="elh_employees_Region" for="x_Region" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->Region->caption() ?><?php echo ($employees->Region->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->Region->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Region">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_Region"><?php echo $employees->Region->caption() ?><?php echo ($employees->Region->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_PostalCode" class="form-group row">
		<label id="elh_employees_PostalCode" for="x_PostalCode" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->PostalCode->caption() ?><?php echo ($employees->PostalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->PostalCode->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_PostalCode">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_PostalCode"><?php echo $employees->PostalCode->caption() ?><?php echo ($employees->PostalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_Country" class="form-group row">
		<label id="elh_employees_Country" for="x_Country" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->Country->caption() ?><?php echo ($employees->Country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->Country->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Country">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_Country"><?php echo $employees->Country->caption() ?><?php echo ($employees->Country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_HomePhone" class="form-group row">
		<label id="elh_employees_HomePhone" for="x_HomePhone" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->HomePhone->caption() ?><?php echo ($employees->HomePhone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->HomePhone->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_HomePhone">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_HomePhone"><?php echo $employees->HomePhone->caption() ?><?php echo ($employees->HomePhone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_Extension" class="form-group row">
		<label id="elh_employees_Extension" for="x_Extension" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->Extension->caption() ?><?php echo ($employees->Extension->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->Extension->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Extension">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_Extension"><?php echo $employees->Extension->caption() ?><?php echo ($employees->Extension->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_Notes" class="form-group row">
		<label id="elh_employees_Notes" for="x_Notes" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->Notes->caption() ?><?php echo ($employees->Notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_ReportsTo" class="form-group row">
		<label id="elh_employees_ReportsTo" for="x_ReportsTo" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->ReportsTo->caption() ?><?php echo ($employees->ReportsTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->ReportsTo->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_ReportsTo">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_ReportsTo"><?php echo $employees->ReportsTo->caption() ?><?php echo ($employees->ReportsTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_UserLevel" class="form-group row">
		<label id="elh_employees_UserLevel" for="x_UserLevel" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->UserLevel->caption() ?><?php echo ($employees->UserLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
	<tr id="r_UserLevel">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_UserLevel"><?php echo $employees->UserLevel->caption() ?><?php echo ($employees->UserLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_Activated" class="form-group row">
		<label id="elh_employees_Activated" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->Activated->caption() ?><?php echo ($employees->Activated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
	<tr id="r_Activated">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_Activated"><?php echo $employees->Activated->caption() ?><?php echo ($employees->Activated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($employees_add->IsMobileOrModal) { ?>
	<div id="r_Profile" class="form-group row">
		<label id="elh_employees_Profile" for="x_Profile" class="<?php echo $employees_add->LeftColumnClass ?>"><?php echo $employees->Profile->caption() ?><?php echo ($employees->Profile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_add->RightColumnClass ?>"><div<?php echo $employees->Profile->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Profile">
		<td class="<?php echo $employees_add->TableLeftColumnClass ?>"><span id="elh_employees_Profile"><?php echo $employees->Profile->caption() ?><?php echo ($employees->Profile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
